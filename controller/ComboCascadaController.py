...
class ComboCascadaController:
    ...
    def __init__(self) -> None:
        ...
        self.agregarGeneros()
        self.ventana.cbogenero.activated.connect(self.selectedCboGenero)
        self.ventana.cbonombres.activated.connect(self.selectedCboNombre)
        self.ventana.show()
        app.exec()
    ...
    def selectedCboNombre(self):
        if self.ventana.cbonombres.currentData() == "0":
            ...
            self.ventana.lblresultado.setText(self.ventana.cbonombres.currentText())
    ...
    def agregarNombresFemenino(self):
        ...
        self.ventana.cbonombres.addItem("Carla")
